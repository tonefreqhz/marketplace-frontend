...
export function fetchSubscribers(){
  return dispatch => fetch(`${process.env.REACT_APP_API_URL_CALL}/api/v1/subscribers`,
 { method: 'GET'})
...
export function deleteSubscriber(subscriberID) {
  ...
  return dispatch => fetch(`${process.env.REACT_APP_API_URL_CALL}/api/v1/subscribers/${subscriberID}`, {
    method: 'DELETE',
    headers: {
