...
export function fetchCustomers(){
  return dispatch => fetch(`${process.env.REACT_APP_API_URL_CALL}/api/v1/customers`,
 { method: 'GET'})
...
export function deleteCustomers(customerID) {
  ...
  return dispatch => fetch(`${process.env.REACT_APP_API_URL_CALL}/api/v1/customers/${customerID}`, {
    method: 'DELETE',
    headers: {
